const Whoweare = () => {
  return (
    <div className="dark:bg-black px-4 md:px-0 m-0">
      <div className="flex flex-col md:flex-row items-start gap-6 md:gap-90 max-w-[1500px] mx-auto">
        {/* Badge on the left */}
        ...
        {/* Text on the right */}
        <p className="sm:text-lg md:text-[32px] leading-relaxed dark:text-white">
